...
!function (e, t) {
    ...
    function nb(e, t) {
        ...
        if (1 === t.nodeType) {
            if (L.hasData(e) && (s = L.access(e), a = L.set(t, s), l = s.events)) {
                ...
                for (o in l)for (r = 0, i = l[o].length; i > r; r++)n.event.add(t, o, l[o][r])
            }
    ...
    function Fb(e, t) {
        if (t in e)return t;
        for (var n = t[0].toUpperCase() + t.slice(1), r = t, i = Eb.length; i--;)if (t = Eb[i] + n, t in e)return t;
        return r
    }
    ...
    function Ib(e, t, r) {
        var i = !0, o = "width" === t ? e.offsetWidth : e.offsetHeight, s = wb(e), a = "border-box" === n.css(e, "boxSizing", !1, s);
        if (0 >= o || null == o) {
    ...
    function Vb(e, t, r) {
        ...
        if (n.isEmptyObject(d)) "inline" === ("none" === l ? tb(e.nodeName) : l) && (h.display = l); else {
    ...
    function Wb(e, t) {
        var r, i, o, s, a;
        for (r in e)if (i = n.camelCase(r), o = t[i], s = e[r], n.isArray(s) && (o = s[1], s = e[r] = s[0]), r !== i && (e[i] = s, delete e[r]), a = n.cssHooks[i], a && "expand" in a) {
    ...
    function Xb(e, t, r) {
        ...
        for (Wb(f, l.opts.specialEasing); a > s; s++)if (i = Qb[s].call(l, e, f, l.opts))return i;
    ...
    function qc(e) {
        return function (t, r) {
            ...
            if (n.isFunction(r))for (; i = s[o++];)"+" === i[0] ? (i = i.slice(1) || "*", (e[i] = e[i] || []).unshift(r)) : (e[i] = e[i] || []).push(r)
        }
    }
    ...
    function Ac(e, t, r, i) {
        ...
        }); else if (r || "object" !== n.type(t)) i(e, t); else for (o in t)Ac(e + "[" + o + "]", t[o], r, i)
    }
    ...
    var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString, j = h.hasOwnProperty, k = {}, l = a.document, m = "2.1.3", n = function (e, t) {
    ...
    n.fn = n.prototype = {
        ...
        for ("boolean" == typeof a && (l = a, a = arguments[u] || {}, u++), "object" == typeof a || n.isFunction(a) || (a = {}), u === c && (a = this, u--); c > u; u++)if (null != (e = arguments[u]))for (t in e)r = a[t], i = e[t], a !== i && (l && i && (n.isPlainObject(i) || (o = n.isArray(i))) ? (o ? (o = !1, s = r && n.isArray(r) ? r : []) : s = r && n.isPlainObject(r) ? r : {}, a[t] = n.extend(l, s, i)) : void 0 !== i && (a[t] = i));
        return a
    }, n.extend({
        expando: "jQuery" + (m + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            if (u)for (; a > o; o++)i = n(t[o], o, r), null != i && c.push(i); else for (o in t)i = n(t[o], o, r), null != i && c.push(i);
            return e.apply([], c)
    ...
    var t = function (e) {
        ...
        function v(e, t, n, i, o, s) {
            return i && !i[$] && (i = v(i)), o && !o[$] && (o = v(o, s)), r(function (r, s, a, u) {
                ...
                if (n && n(y, b, a, u), i)for (c = m(b, d), i(c, [], a, u), l = c.length; l--;)(f = c[l]) && (b[d[l]] = !(y[d[l]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function y(e) {
            for (var t, n, r, i = e.length, o = T.relative[e[0].type], s = o || T.relative[" "], a = o ? 1 : 0, u = d(function (e) {
                ...
                return t = null, i
            }]; i > a; a++)if (n = T.relative[e[a].type]) l = [d(h(l), n)]; else {
        ...
        w = t.support = {}, k = t.isXML = function (e) {
            ...
            var n = T.attrHandle[t.toLowerCase()], r = n && J.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !M) : void 0;
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (l = m[$] || (m[$] = {}), c = l[e] || [], d = c[0] === _ && c[1], p = c[0] === _ && c[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();)if (1 === f.nodeType && ++p && f === t) {
                                    l[e] = [_, d, p];
                                    break
                                }
                            } else if (y && (c = (t[$] || (t[$] = {}))[e]) && c[0] === _) p = c[1]; else for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (y && ((f[$] || (f[$] = {}))[e] = [_, p]), f !== t)););
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, E = t.tokenize = function (e, n) {
            ...
            if (n = n || [], 1 === f.length) {
                ...
                for (i = ht.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !T.relative[a = s.type]);)if ((u = T.find[a]) && (r = u(s.matches[0].replace(wt, Tt), bt.test(o[0].type) && l(t.parentNode) || t))) {
    ...
    n.filter = function (e, t, r) {
        ...
        find: function (e) {
            ...
            if ("string" != typeof e)return this.pushStack(n(e).filter(function () {
                for (t = 0; r > t; t++)if (n.contains(o[t], this))return !0
            }));
    ...
    eval(function (e, t, n, r, i, o) {
        ...
        dir: function (e, t, r) {
            for (var i = [], o = void 0 !== r; (e = e[t]) && 9 !== e.nodeType;)if (1 === e.nodeType) {
                if (o && n(e).is(r))break;
                i.push(e)
            }
            return i
        ...
        has: function (e) {
            ...
            for (var r, i = 0, o = this.length, s = [], a = u.test(e) || "string" != typeof e ? n(e, t || this.context) : 0; o > i; i++)for (r = this[i]; r && r !== t; r = r.parentNode)if (r.nodeType < 11 && (a ? a.index(r) > -1 : 1 === r.nodeType && n.find.matchesSelector(r, e))) {
                s.push(r);
                break
            }
    ...
    n.Callbacks = function (e) {
        ...
        var t, r, i, o, s, a, u = [], c = !e.once && [], l = function (n) {
            for (t = e.memory && n, r = !0, a = o || 0, o = 0, s = u.length, i = !0; u && s > a; a++)if (u[a].apply(n[0], n[1]) === !1 && e.stopOnFalse) {
                t = !1;
                break
            }
            ...
            add: function () {
                ...
                return u && n.each(arguments, function (e, t) {
                    for (var r; (r = n.inArray(t, u, r)) > -1;)u.splice(r, 1), i && (s >= r && s--, a >= r && a--)
                }), this
            }, has: function (e) {
        ...
        Deferred: function (e) {
            ...
            if (a > 1)for (t = new Array(a), r = new Array(a), i = new Array(a); a > o; o++)s[o] && n.isFunction(s[o].promise) ? s[o].promise().done(l(o, i, s)).fail(c.reject).progress(l(o, r, t)) : --u;
    ...
    var J = n.access = function (e, t, r, i, o, s, a) {
        ...
        if ("object" === n.type(r)) {
            ...
            for (u in r)n.access(e, t, u, r[u], !0, s, a)
                ...
                return l.call(n(e), r)
            })), t))for (; c > u; u++)t(e[u], r, a ? i : i.call(e[u], u, t(e[u], r)));
    ...
    n.acceptData = function (e) {
        ...
        key: function (e) {
            ...
            if ("string" == typeof t) s[t] = r; else if (n.isEmptyObject(s)) n.extend(this.cache[o], t); else for (i in t)s[i] = t[i];
            return s
        }, get: function (e, t) {
    ...
    n.extend({
        ...
        queue: function (e, t, r) {
            ...
            t = t || "fx";
            var r = n.queue(e, t), i = r.length, o = r.shift(), s = n._queueHooks(e, t), a = function () {
                n.dequeue(e, t)
            };
    ...
    n.event = {
        ...
        add: function (e, t, r, i, o) {
            ...
            if (v)for (r.handler && (s = r, r = s.handler, o = s.selector), r.guid || (r.guid = n.guid++), (c = v.events) || (c = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
        ...
        remove: function (e, t, r, i, o) {
            ...
            if (v && (c = v.events)) {
                for (t = (t || "").match(E) || [""], l = t.length; l--;)if (u = Y.exec(t[l]) || [], h = m = u[1], g = (u[2] || "").split(".").sort(), h) {
                ...
                } else for (h in c)n.event.remove(e, h + t[l], r, i, !0);
        ...
        trigger: function (e, t, r, i) {
            ...
            if (s = u = r = r || l, 3 !== r.nodeType && 8 !== r.nodeType && !X.test(g + n.event.triggered) && (g.indexOf(".") >= 0 && (m = g.split("."), g = m.shift(), m.sort()), f = g.indexOf(":") < 0 && "on" + g, e = e[n.expando] ? e : new n.Event(g, "object" == typeof e && e), e.isTrigger = i ? 2 : 3, e.namespace = m.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : n.makeArray(t, [e]), d = n.event.special[g] || {}, i || !d.trigger || d.trigger.apply(r, t) !== !1)) {
                ...
                for (o = 0; (s = h[o++]) && !e.isPropagationStopped();)e.type = o > 1 ? c : d.bindType || g, p = (L.get(s, "events") || {})[e.type] && L.get(s, "handle"), p && p.apply(s, t), p = f && s[f], p && p.apply && n.acceptData(s) && (e.result = p.apply(s, t), e.result === !1 && e.preventDefault());
        ...
        dispatch: function (e) {
            ...
            if (u[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
                for (a = n.event.handlers.call(this, e, c), t = 0; (o = a[t++]) && !e.isPropagationStopped();)for (e.currentTarget = o.elem, r = 0; (s = o.handlers[r++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(s.namespace)) && (e.handleObj = s, e.data = s.data, i = ((n.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, u), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
    ...
    var bd = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, bb = /<([\w:]+)/, cb = /<|&#?\w+;/, db = /<(?:script|style|link)/i, eb = /checked\s*(?:[^=]|=\s*.checked.)/i, fb = /^$|\/(?:java|ecma)script/i, gb = /^true\/(.*)/, hb = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, ib = {
    ...
    ib.optgroup = ib.option, ib.tbody = ib.tfoot = ib.colgroup = ib.caption = ib.thead, ib.th = ib.td, n.extend({
        clone: function (e, t, r) {
            ...
            if (!(k.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || n.isXMLDoc(e)))for (a = ob(u), s = ob(e), i = 0, o = s.length; o > i; i++)pb(s[i], a[i]);
            if (t)if (r)for (s = s || ob(e), a = a || ob(u), i = 0, o = s.length; o > i; i++)nb(s[i], a[i]); else nb(e, u);
            return a = ob(u, "script"), a.length > 0 && mb(a, !c && ob(e, "script")), u
        }, buildFragment: function (e, t, r, i) {
            for (var o, s, a, u, c, l, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; h > d; d++)if (o = e[d], o || 0 === o)if ("object" === n.type(o)) n.merge(p, o.nodeType ? [o] : o); else if (cb.test(o)) {
            ...
            for (f.textContent = "", d = 0; o = p[d++];)if ((!i || -1 === n.inArray(o, i)) && (c = n.contains(o.ownerDocument, o), s = ob(f.appendChild(o), "script"), c && mb(s), r))for (l = 0; o = s[l++];)fb.test(o.type || "") && r.push(o);
            return f
        }, cleanData: function (e) {
            for (var t, r, i, o, s = n.event.special, a = 0; void 0 !== (r = e[a]); a++) {
                if (n.acceptData(r) && (o = r[L.expando], o && (t = L.cache[o]))) {
                    if (t.events)for (i in t.events)s[i] ? n.event.remove(r, i) : n.removeEvent(r, i, t.handle);
        ...
        text: function (e) {
            ...
            if (f && (i = n.buildFragment(t, this[0].ownerDocument, !1, this), o = i.firstChild, 1 === i.childNodes.length && (i = o), o)) {
                ...
                if (a)for (c = s[s.length - 1].ownerDocument, n.map(s, lb), l = 0; a > l; l++)u = s[l], fb.test(u.type || "") && !L.access(u, "globalEval") && n.contains(c, u) && (u.src ? n._evalUrl && n._evalUrl(u.src) : n.globalEval(u.textContent.replace(hb, "")))
            }
            return this
        }
    }), n.each({
    ...
    var bg = /^(none|table(?!-c[ea]).+)/, Ab = new RegExp("^(" + Q + ")(.*)$", "i"), Bb = new RegExp("^([+-])=(" + Q + ")", "i"), Cb = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    n.extend({
        ...
        constructor: Kb, init: function (e, t, r, i, o, s) {
    ...
    var bh, Mb, Nb = /^(?:toggle|show|hide)$/, Ob = new RegExp("^(?:([+-])=|)(" + Q + ")([a-z%]*)$", "i"), Pb = /queueHooks$/, Qb = [Vb], Rb = {
        "*": [function (e, t) {
            var r = this.createTween(e, t), i = r.cur(), o = Ob.exec(t), s = o && o[3] || (n.cssNumber[e] ? "" : "px"), a = (n.cssNumber[e] || "px" !== s && +i) && Ob.exec(n.css(r.elem, e)), u = 1, c = 20;
            if (a && a[3] !== s) {
                s = s || a[3], o = o || [], a = +i || 1;
    ...
    n.Animation = n.extend(Xb, {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            var o = n.isEmptyObject(e), s = n.speed(t, r, i), a = function () {
            ...
            return "string" != typeof e && (r = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                var t = !0, o = null != e && e + "queueHooks", s = n.timers, a = L.get(this);
                if (o) a[o] && a[o].stop && i(a[o]); else for (o in a)a[o] && a[o].stop && Pb.test(o) && i(a[o]);
    ...
    n.fn.extend({
        ...
        attr: function (e, t, r) {
            ...
            if (s && 1 === e.nodeType)for (; r = s[o++];)i = n.propFix[r] || r, n.expr.match.bool.test(r) && (e[i] = !1), e.removeAttribute(r)
        }, attrHooks: {
            type: {
                set: function (e, t) {
    ...
    n.fn.extend({
        addClass: function (e) {
            ...
            if (u)for (t = (e || "").match(E) || []; l > c; c++)if (r = this[c], i = 1 === r.nodeType && (r.className ? (" " + r.className + " ").replace(bk, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" === r ? t ? this.addClass(e) : this.removeClass(e) : this.each(n.isFunction(e) ? function (r) {
                ...
                if ("string" === r)for (var t, i = 0, o = n(this), s = e.match(E) || []; t = s[i++];)o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else(r === U || "boolean" === r) && (this.className && L.set(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : L.get(this, "__className__") || "")
            })
        }, hasClass: function (e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(bk, " ").indexOf(t) >= 0)return !0;
            return !1
        }
    });
    var bl = /\r/g;
    n.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, r, i = e.options, o = e.selectedIndex, s = "select-one" === e.type || 0 > o, a = s ? null : [], u = s ? o + 1 : i.length, c = 0 > o ? u : s ? o : 0; u > c; c++)if (r = i[c], !(!r.selected && c !== o || (k.optDisabled ? r.disabled : null !== r.getAttribute("disabled")) || r.parentNode.disabled && n.nodeName(r.parentNode, "optgroup"))) {
        ...
        ajax: function (e, t) {
            ...
            var i, o, s, a, u, c, l, f, p = n.ajaxSetup({}, t), d = p.context || p, h = p.context && (d.nodeType || d.jquery) ? n(d) : n.event, g = n.Deferred(), m = n.Callbacks("once memory"), v = p.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", T = {
                ...
                getResponseHeader: function (e) {
                    var t;
                    if (2 === x) {
                        if (!a)for (a = {}; t = gc.exec(s);)a[t[1].toLowerCase()] = t[2];
                        t = a[e.toLowerCase()]
                    }
    ...
    var bp = 0, Cc = {}, Dc = {0: 200, 1223: 204}, Ec = n.ajaxSettings.xhr();
    a.attachEvent && a.attachEvent("onunload", function () {
        ...
        return k.cors || Ec && !e.crossDomain ? {
            send: function (n, r) {
                ...
                t = function (e) {
                    return function () {
                        t && (delete Cc[s], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(Dc[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {text: o.responseText} : void 0, o.getAllResponseHeaders()))
                    }
    ...
    n.offset = {
        ...
        offset: function (e) {
            ...
            var t, r, i = this[0], o = {top: 0, left: 0}, s = i && i.ownerDocument;
...
(function (b, e) {
    ...
    var f = "debugads" in h, q = {}, g = !0, k = {aa: [], ab: [], ac: []};
    b.adSlots = k;
    var n = !1, p = null, l = function (a) {
        a.defineSlot = function (a, d, e) {
            var c = b.googletag;
            return {type: "dfpads", data: c.defineSlot(a, d, e).addService(c.pubads())}
        };
        return a
    }({});
    b.googleAdsModule = l;
    ...
    b.openVideoAd = function () {
        null != SSA_CORE && r && SSA_CORE.BrandConnect.engage()
    };
    ...
    // (function () {
    //     var a = {}, c = null, d = null, e = null, f = null, h = -1 != b.location.search.indexOf("fb"), g = t.a;
    ...
    //     var m = b.googletag;
    //     m.cmd.push(function () {
    //         m.pubads().setTargeting("abtest", w("ABGroupDFP") + "");
...
(function (exports) {
    ...
    SmoothieChart.prototype.render = function (canvas, time) {
        ...
        }, oldestValidTime = time - dimensions.width * chartOptions.millisPerPixel, valueToYPixel = function (value) {
        ...
        if (chartOptions.horizontalLines && chartOptions.horizontalLines.length) {
            for (var hl = 0; hl < chartOptions.horizontalLines.length; hl++) {
                var line = chartOptions.horizontalLines[hl], hly = Math.round(valueToYPixel(line.value)) - .5;
        ...
        if (!chartOptions.labels.disabled && !isNaN(this.valueRange.min) && !isNaN(this.valueRange.max)) {
            var maxValueString = chartOptions.yMaxFormatter(this.valueRange.max, chartOptions.labels.precision), minValueString = chartOptions.yMinFormatter(this.valueRange.min, chartOptions.labels.precision), labelPos = chartOptions.scrollBackwards ? 0 : dimensions.width - context.measureText(maxValueString).width - 2;
...
var cc = {
    ...
    strings: {
        ...
        notificationTitle: "This site uses cookies! By continuing to browse the site you are consenting to our use of cookies.",
...
if (!window.jQuery) {
    ...
    s.setAttribute("src", "js/jquery-1.7.2.min.js");
